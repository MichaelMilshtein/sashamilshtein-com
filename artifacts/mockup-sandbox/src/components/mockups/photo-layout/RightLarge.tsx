    ...
    <div style={{
      ...
      <div style={{ ...glass, borderRadius: "22px", overflow: "hidden", display: "flex", marginBottom: "16px" }}>
        ...
        <div style={{ width: "220px", flexShrink: 0, position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", inset: 0, left: 0, width: "40px", background: "linear-gradient(to right, rgba(18,25,54,0.7), transparent)" }} />
        </div>
      </div>
