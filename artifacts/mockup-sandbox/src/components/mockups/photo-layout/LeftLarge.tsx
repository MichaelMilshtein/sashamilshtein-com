...
export function LeftLarge() {
  return (
    <div style={{
      ...
      {/* Merged header + summary block with large photo on LEFT */}
      <div style={{ ...glass, borderRadius: "22px", overflow: "hidden", display: "flex", marginBottom: "16px" }}>
        {/* Left: large photo */}
        <div style={{ width: "200px", flexShrink: 0, position: "relative" }}>
          ...
          />
          {/* Subtle gradient blend on right edge */}
          <div style={{ position: "absolute", inset: 0, right: 0, left: "auto", width: "40px", background: "linear-gradient(to left, rgba(18,25,54,0.7), transparent)" }} />
        </div>
        {/* Right: name + summary text */}
        <div style={{ flex: 1, padding: "20px 24px" }}>
          ...
          {/* Summary text */}
          <p style={{ margin: 0, fontSize: "0.92rem", lineHeight: 1.75, color: "#c8d0f0" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: "16px", opacity: 0.35 }}>
        <div style={{ ...glass, borderRadius: "18px", height: "80px" }} />
        <div style={{ ...glass, borderRadius: "18px", height: "80px" }} />
      </div>
    </div>
  );
